...
hl.bind("SUPER + SHIFT + CTRL + right", hl.dsp.window.move({ x = 30, y = 0, relative = true }), { repeating = true })
hl.bind("SUPER + SHIFT + CTRL + left", hl.dsp.window.move({ x = -30, y = 0, relative = true }), { repeating = true })
hl.bind("SUPER + SHIFT + CTRL + up", hl.dsp.window.move({ x = 0, y = -30, relative = true }), { repeating = true })
hl.bind("SUPER + SHIFT + CTRL + down", hl.dsp.window.move({ x = 0, y = 30, relative = true }), { repeating = true })

hl.bind(mainMod .. " + Tab", hl.dsp.window.move({ monitor = "+1" }))
...
hl.bind("XF86AudioRaiseVolume", hl.dsp.exec_cmd("~/.config/hypr/scripts/audio.sh 5"), { locked = true, repeating = true })
hl.bind("XF86AudioLowerVolume", hl.dsp.exec_cmd("~/.config/hypr/scripts/audio.sh -5"),
	{ locked = true, repeating = true })
hl.bind("XF86AudioMute", hl.dsp.exec_cmd("~/.config/hypr/scripts/audio.sh mute"), { locked = true, repeating = true })
